    ...
    <div className='min-h-screen flex flex-col md:flex-row'>
        ...
        <div>
            <div className='flex items-center gap-3 mb-4 max-md:mt-10'>
                ...
                <div>
                    <div className='flex'>
                        {Array(5).fill(0).map((_,i)=>(<Star key ={i} className='size-4 md:size-4.5 text-tranparent fill-amber-500'/>))}
                    </div>
                    <p>Used by 12k developers</p>
                </div>
            </div>
            <h1 className='text-3xl md:text-6xl md:pb-2 font-bold bg-gradient-to-r from-indigo-950 to-indigo-800 bg-clip-text text-transparent'>More than just friend truly connect</h1>
