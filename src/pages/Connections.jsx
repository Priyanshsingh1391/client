        ...
        >
          {dataArray.map((tab) => (
            ...
            >
              ...
              <span className="ml-1 text-gray-400">({tab.value.length})</span>
            </button>
          ))}
        </div>
        ...
        <div className="flex flex-wrap gap-6 mt-6">
          {dataArray
            ...
            ?.value.map((user) => (
              <div
                key={user._id}
                className="max-w-88 flex gap-5 p-6 bg-white shadow rounded-md"
              >
                <img
                ...
                <div className="flex-1">
                  ...
                  <div className="flex max-sm:flex-col gap-2 mt-4">
                    ...
                    <button
                      ...
                      from-indigo-500 to-purple-600 hover:to-purple-700 active:scale-95 
